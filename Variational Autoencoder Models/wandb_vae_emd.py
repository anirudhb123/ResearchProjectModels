...
##
##np.save('/abvol/fpr/fpr (vbfhh,vae_emd).npy',fpr22)
##np.save('/abvol/tpr/tpr (vbfhh,vae_emd).npy',tpr22)
##
##np.save('/abvol/fpr/fpr (ttbar,vae_emd).npy',fpr42)
##np.save('/abvol/tpr/tpr (ttbar,vae_emd).npy',tpr42)
##
  #  metrics = {
  #      'zvv_AUC':auc_12,
  #      'ztt_AUC':auc_32
...
plt.xlim(0,300)
plt.legend()
plt.savefig('/abvol/eff_plots/met_efficiency (emd) - all.png')
...
plt.ylabel('ratio')
plt.xlim(0,300)
plt.savefig('/abvol/eff_plots/met_efficiency2 (emd).png')
...
plt.ylabel('ratio')
plt.xlim(0,300)
plt.savefig('/abvol/eff_plots/met_efficiency2 (emd), log.png')
