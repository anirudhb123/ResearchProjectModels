...
trainingData = np.append(nom_met[0:nomTrainingDataLength], signal_mets[0:vbfhhTrainingDataLength], axis=0)

validationData = np.append(nom_met[nomTrainingDataLength:nomTrainingDataLength + nomValidationDataLength], signal_mets[signalTrainingDataLength:signalTrainingDataLength + signalValidationDataLength], axis=0)

testData = np.append(nom_met[nomTrainingDataLength + nomValidationDataLength:nomTrainingDataLength + nomValidationDataLength + nomTestDataLength], signal_mets[signalTrainingDataLength + signalValidationDataLength:signalTrainingDataLength + signalValidationDataLength + signalTestDataLength], axis=0)

trainingLabels = np.append(np.zeros(nomTrainingDataLength), np.ones(signalTrainingDataLength))
validationLabels = np.append(np.zeros(nomValidationDataLength), np.ones(signalValidationDataLength))
testLabels = np.append(np.zeros(nomTestDataLength), np.ones(signalTestDataLength))
...
train_weights = np.power(np.reciprocal(np.concatenate((nom_met[0:nomTrainingDataLength], signal_mets[0:signalTrainingDataLength]), axis=0)), 3) * 1000
val_weights = np.power(np.reciprocal(np.concatenate((nom_met[nomTrainingDataLength:nomValidationDataLength], signal_mets[signalTrainingDataLength:signalValidationDataLength]), axis=0)), 3) * 1000
...
train_weights = replace_values(np.concatenate((nom_met[0:nomTrainingDataLength], signal_mets[0:signalTrainingDataLength]), axis=0), 100)
val_weights = replace_values(np.concatenate((nom_met[nomTrainingDataLength:nomValidationDataLength], signal_mets[signalTrainingDataLength:signalValidationDataLength]), axis=0), 100)
...
mets = np.concatenate([nom_met[(-1 * nomTestDataLength):], signal_mets[(-1 * signalTestDataLength):]])
