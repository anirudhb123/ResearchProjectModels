...
trainingData = np.append(nomClusterData[0:nomTrainingDataLength], vbfhh[0:vbfhhTrainingDataLength], axis=0)

validationData = np.append(nomClusterData[nomTrainingDataLength:nomTrainingDataLength + nomValidationDataLength], vbfhh[vbfhhTrainingDataLength:vbfhhTrainingDataLength + vbfhhValidationDataLength], axis=0)

testData = np.append(nomClusterData[nomTrainingDataLength + nomValidationDataLength:nomTrainingDataLength + nomValidationDataLength + nomTestDataLength], vbfhh[vbfhhTrainingDataLength + vbfhhValidationDataLength:vbfhhTrainingDataLength + vbfhhValidationDataLength + vbfhhTestDataLength], axis=0)
...
np.save('/abvol/fpr/fpr (vbfhh,supervised).npy', fpr)
np.save('/abvol/tpr/tpr (vbfhh,supervised).npy', tpr)
...
plt.legend()
plt.savefig('/abvol/ROC_Curves/ROC Curve (vbfhh,supervised).png')
...
np.save('/abvol/mets/mets (vbfhh,supervised).npy', mets)
np.save('/abvol/val_mets/val_mets (vbfhh,supervised).npy', valid_mets)
...
plt.legend()
plt.savefig('/abvol/eff_plots/met_efficiency (vbfhh, supervised).png')
...
plt.xlim(0,300)
plt.legend()
plt.savefig('/abvol/eff_plots/met_efficiency (vbfhh, supervised), log.png')
...
np.save('/abvol/bins/(vbfhh,supervised).npy', bins1)
np.save('/abvol/divisors/(vbfhh,supervised).npy', divisors)
...
plt.xlim(0,300)
plt.ylim(0,1)
plt.savefig('/abvol/eff_plots/met_efficiency2 (vbfhh, supervised).png')
...
plt.xlim(0,300)
plt.ylim(0.01,1)
plt.savefig('/abvol/eff_plots/met_efficiency2 (vbfhh, supervised), log.png')
