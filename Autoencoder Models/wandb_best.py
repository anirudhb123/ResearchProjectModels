...
plt.xlim(0,300)
plt.legend()
plt.savefig('/abvol/eff_plots/met_efficiency (best) - all.png')
...
plt.yscale('log')
plt.legend()
plt.savefig('/abvol/eff_plots/met_efficiency (best), log.png')
...
plt.ylabel('ratio')
plt.xlim(0,300)
plt.savefig('/abvol/eff_plots/met_efficiency2 (best).png')
...
plt.ylabel('ratio')
plt.xlim(0,300)
plt.savefig('/abvol/eff_plots/met_efficiency2 (best), log.png')
