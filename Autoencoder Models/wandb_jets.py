...
# print("Extracting")
nom_bkg_jz0 = np.load("/abvol/GepOutput_SK/jz0_pu200_skjets_30.npy", 'r')
nom_bkg_jz1 = np.load("/abvol/GepOutput_SK/jz1_pu200_skjets_30.npy", 'r')
nom_bkg_jz2 = np.load("/abvol/GepOutput_SK/jz2_pu200_skjets_30.npy", 'r')
nom_sig_zvvhbb = np.load("/abvol/GepOutput_SK/zvvhbb_pu200_skjets_30.npy", 'r')
nom_sig_ztautau = np.load("/abvol/GepOutput_SK/ztautau_pu200_skjets_30.npy", 'r')
nom_sig_vbfhh = np.load("/abvol/GepOutput_SK/vbfhhbbbb_pu200_skjets_30.npy", 'r')
nom_sig_ttbar = np.load("/abvol/GepOutput_SK/ttbar_pu200_skjets_30.npy", 'r')


nom_bkg_jz0 = nom_bkg_jz0[:,:10,:]
nom_bkg_jz1 = nom_bkg_jz1[:,:10,:]
nom_bkg_jz2 = nom_bkg_jz2[:,:10,:]
nom_sig_zvvhbb = nom_sig_zvvhbb[:,:10,:]
nom_sig_ztautau = nom_sig_ztautau[:,:10,:]
nom_sig_vbfhh = nom_sig_vbfhh[:,:10,:]
nom_sig_ttbar = nom_sig_ttbar[:,:10,:]

print(nom_bkg_jz0.shape)

ajz0_met = np.load("/abvol/GepOutput_SK/jz0_pu200_skmet.npy", 'r')
ajz1_met = np.load("/abvol/GepOutput_SK/jz1_pu200_skmet.npy", 'r')
ajz2_met = np.load("/abvol/GepOutput_SK/jz2_pu200_skmet.npy", 'r')
azvvhbb_met = np.load("/abvol/GepOutput_SK/zvvhbb_pu200_skmet.npy", 'r')
aztautau_met = np.load("/abvol/GepOutput_SK/ztautau_pu200_skmet.npy", 'r')
avbfhh_met = np.load("/abvol/GepOutput_SK/vbfhhbbbb_pu200_skmet.npy", 'r')
attbar_met = np.load("/abvol/GepOutput_SK/ttbar_pu200_skmet.npy", 'r')
...
indices = np.where((nom_met[:,0]).flatten() > 25)
nom_data = nom_data[indices]
nom_met = nom_met[indices]
...
# Input
inputCluster = Input(shape=(10, 3), name='inputCluster')

# Latent Space
flatten = Flatten()(inputCluster)
...
def custom_loss(y_true, y_pred):
    ...
    return K.mean(weighted_mse, axis=[1, 2])
...
def weighted_loss(y_true, y_pred, weight_factor=fpr_weight):
    ...
    return np.mean(weighted_mse, axis=(1, 2))
...
plt.legend()
plt.savefig('/abvol/ROC_Curves/ROC Curve (jets).png')
...
plt.xlim(0,300)
plt.legend()
plt.savefig('/abvol/eff_plots/met_efficiency (jet) - all.png')
...
plt.yscale('log')
plt.legend()
plt.savefig('/abvol/eff_plots/met_efficiency (jet), log.png')
...
plt.ylabel('ratio')
plt.xlim(0,300)
plt.savefig('/abvol/eff_plots/met_efficiency2 (jet).png')
...
plt.ylabel('ratio')
plt.xlim(0,300)
plt.savefig('/abvol/eff_plots/met_efficiency2 (jet), log.png')
...
plt.ylabel('frequency')
plt.legend()
plt.savefig('/abvol/pt_efficiency/pt_efficiency (jet,zvvbhbb).png')
...
plt.ylabel('frequency')
plt.legend()
plt.savefig('/abvol/pt_efficiency/pt_efficiency (jet,vbfhh).png')
...
plt.ylabel('frequency')
plt.legend()
plt.savefig('/abvol/pt_efficiency/pt_efficiency (jet,ttbar).png')
...
plt.ylabel('ratio')
plt.legend()
plt.savefig('/abvol/pt_efficiency/pt_efficiency2 (jet,zvvhbb).png')
...
plt.ylabel('ratio')
plt.legend()
plt.savefig('/abvol/pt_efficiency/pt_efficiency2 (jet,vbfhh).png')
...
plt.ylabel('ratio')
plt.legend()
plt.savefig('/abvol/pt_efficiency/pt_efficiency2 (jet,ttbar).png')
